...
# Database: medicine
# Generation Time: 2016-06-21 06:23:13 +0000
# ************************************************************
...
INSERT INTO `medic_return` (`ret_id`, `sell_id`, `ret_amount`, `totalprice`, `time`, `return_by`, `reason`)
VALUES
	(1,2,3,15.30,33,1,'无效'),
	(2,1,2,1.00,1466257348,1,''),
	(3,4,1,3.20,1466389378,1,''),
	(4,5,1,3.20,1466389663,1,''),
	(5,6,2,36.40,1466389790,1,''),
	(6,7,1,15.00,1466390096,1,'');
...
CREATE TABLE `medic_sell` (
  ...
  `allprice` decimal(8,2) NOT NULL COMMENT '销售总额',
  `time` int(11) NOT NULL COMMENT '销售日期',
  `sell_by` int(11) unsigned NOT NULL DEFAULT '1' COMMENT '操作员id',
...
INSERT INTO `medic_sell` (`sell_id`, `stock_id`, `price`, `sell_amount`, `allprice`, `time`, `sell_by`, `sell_status`)
VALUES
	(1,2,3.00,1,3.00,13,1,1),
	(2,3,18.20,1,18.20,1466174152,1,0),
	(3,3,18.20,2,36.40,1466174700,1,0),
	(4,6,3.20,1,3.20,1466389341,1,1),
	(5,6,3.20,1,3.20,1466389651,1,1),
	(6,3,18.20,1,18.20,1466389774,1,1),
	(7,1,15.00,1,15.00,1466390076,1,1);
...
VALUES
	(1,1,'Harbin',10,'02301','Hong2313',15.00,0,0,0),
	...
	(6,6,'华润三九（南昌）药业有限公司',3,'8238898','WUS3222',3.20,1466352000,1464710400,1468944000);
...
VALUES
	(1,'201321092028','e10adc3949ba59abbe56e057f20f883e','刘经济',1466488852,1),
