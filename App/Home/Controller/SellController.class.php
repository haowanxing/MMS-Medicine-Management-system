...
class SellController extends Controller
{
    ...
    public function getSellList(){
        ...
        $result = $this->db->join("__STOCK__ ON __STOCK__.stock_id = __SELL__.stock_id")->join("__DRUGS__ ON __DRUGS__.drug_id = __STOCK__.drug_id")->join("__USERS__ ON __USERS__.id = __SELL__.sell_by")->page($page,$limit)->select();
